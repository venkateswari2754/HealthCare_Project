...
USAGE:
    from src.data.data_pipeline import setup_database, load_all_data
...
DOCTORS_SLOTS_DATA = os.path.join(DATA_DIR, "doctors_slots_data.csv")
...
def setup_database():
    ...
    Example:
        >>> from src.data.data_pipeline import setup_database
        >>> setup_database()
    """
    print("\n" + "="*70)
